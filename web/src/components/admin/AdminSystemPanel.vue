...
import type { CaptureConfig, SystemConfig, WxConfig } from '@/composables/useAdminSystemConfig'
...
<template>
  <div class="space-y-4">
    <h3 class="text-lg text-gray-900 font-bold dark:text-gray-100">
      {{ props.section === 'system' ? '系统配置' : props.section === 'wx' ? '微信配置' : '抓包服务' }}
    </h3>
    ...
    <div class="space-y-4">
      ...
      <div v-if="props.section === 'wx'" class="border border-gray-200 rounded-lg bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
        <h4 class="mb-3 flex items-center gap-2 text-base text-gray-900 font-bold dark:text-gray-100">
